namespace KTE_PMS
{
    partial class TrendViewer
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.chartControl1.DataSource = this.Battery_dataBindingSource;
            ...
            xyDiagram1.AxisY.Label.TextPattern = "{V:#,# kW}";
            xyDiagram1.AxisY.VisibleInPanesSerializable = "-1";
            xyDiagram1.DefaultPane.StackedBarTotalLabel.TextPattern = "{V:#,# kW}";
        ...
        series2};
            ...
            // button2
            // 
            this.button2.BackgroundImage = global::KTE_PMS.Properties.Resources.적용_off;
            ...
            textAnnotation2});
            this.chartControl4.CrosshairOptions.GroupHeaderPattern = "{A}";
            ...
            xyDiagram2.AxisY.Label.TextPattern = "{V:#,# A}";
            ...
            this.chartControl4.Location = new System.Drawing.Point(91, 560);
            ...
            series3.CrosshairLabelPattern = "{S} : {V:#.0 A}";
            series3.DataSource = this.Load_dataBindingSource;
            pointSeriesLabel3.TextPattern = "{V:#,# A}";
        ...
        series3};
            ...
            textAnnotation3});
            this.chartControl2.CrosshairOptions.GroupHeaderPattern = "{A}";
            ...
            xyDiagram3.AxisX.InterlacedFillStyle.FillMode = DevExpress.XtraCharts.FillMode.Solid;
            xyDiagram3.AxisX.VisibleInPanesSerializable = "-1";
            xyDiagram3.AxisX.WholeRange.AutoSideMargins = false;
            xyDiagram3.AxisX.WholeRange.SideMarginsValue = 0D;
            xyDiagram3.AxisY.Label.TextPattern = "{V:#,# kW}";
            xyDiagram3.AxisY.VisibleInPanesSerializable = "-1";
            xyDiagram3.DefaultPane.StackedBarTotalLabel.TextPattern = "{V:#.00 kW}";
            ...
            series4.CrosshairLabelPattern = "{S} : {V:#0.00 kW}";
            pointSeriesLabel4.TextPattern = "{V:#.00 kW}";
            series4.Label = pointSeriesLabel4;
            series4.LegendTextPattern = "{V:#.00 kW}";
            series4.Name = "충전누적전력";
            series4.ToolTipPointPattern = "{V:#.00 kW}";
            xySeriesUnwindAnimation1.Duration = System.TimeSpan.Parse("01:00:00.2000000");
            areaSeriesView1.SeriesAnimation = xySeriesUnwindAnimation1;
            xyMarkerWidenAnimation1.Duration = System.TimeSpan.Parse("01:00:00.2000000");
            areaSeriesView1.SeriesPointAnimation = xyMarkerWidenAnimation1;
            series4.View = areaSeriesView1;
            series5.ArgumentDataMember = "DATETIME";
            series5.CrosshairLabelPattern = "{S} : {V:#.00 kW}";
            pointSeriesLabel5.TextPattern = "{V:#.00 kW}";
            series5.Label = pointSeriesLabel5;
            series5.LegendTextPattern = "{V:#.00 kW}";
            series5.Name = "방전누적전력";
            series5.ToolTipPointPattern = "{V:#.00 kW}";
            xySeriesUnwindAnimation2.Duration = System.TimeSpan.Parse("01:00:00.2000000");
            xySeriesUnwindAnimation2.EasingFunction = linearEasingFunction1;
            areaSeriesView2.SeriesAnimation = xySeriesUnwindAnimation2;
            xyMarkerWidenAnimation2.Duration = System.TimeSpan.Parse("01:00:00.2000000");
            areaSeriesView2.SeriesPointAnimation = xyMarkerWidenAnimation2;
        ...
        series5};
            ...
            this.chartControl2.SeriesTemplate.LegendTextPattern = "{V:#.00 kW}";
            this.chartControl2.SeriesTemplate.View = areaSeriesView3;
            ...
            textAnnotation4});
            this.chartControl3.CrosshairOptions.GroupHeaderPattern = "{A}";
            ...
            xyDiagram4.AxisY.Label.TextPattern = "{V:#,# V} ";
