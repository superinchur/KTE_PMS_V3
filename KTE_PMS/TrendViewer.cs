...
namespace KTE_PMS
{
    public partial class TrendViewer : MIMIC.Viewer
    {
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            const int trend_Width = 1480;
            const int trend_Height4 = 160;
            const int trend_Height3 = 217;
            const int trend_Height2 = 326;
            const int trend_Height1 = 660;
            const int location_X = 91;
            const int location_Y1 = 113;
            const int location_Y2 = 279;
            const int location_Y3 = 445;
            const int location_Y4 = 611;
